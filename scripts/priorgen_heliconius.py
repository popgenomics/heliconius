...
if(model=="AM"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTam\tM1\tM2\n"
		if(Mvariation=="hetero"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTam\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTam\tshape0Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTam\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
if(model=="SC"):
	if(Nvariation=="homo"):
		if(Mvariation=="homo"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTsc\tM1\tM2\n"
		if(Mvariation=="hetero"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTsc\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	if(Nvariation=="hetero"):
		if(Mvariation=="homo"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\n"
		if(Mvariation=="hetero"):
			res="N1\tN1past\ttauN1past\tN2\tN2past\ttauN2past\tNa\tTsplit\tTsc\tshape1Ne\tshape2Ne\tpropNtrlNe1\tpropNtrlNe2\tM1\tM2\tshape1M1\tshape2M1\tshape1M2\tshape2M2\tpropNtrlM1\tpropNtrlM2\n"
	...
	for loc in range(nlocus):
		...
		if(model=="AM"):
			#msnsam tbs 200 -t tbs -r tbs tbs -I 2 tbs tbs 0 -m 1 2 0 -m 2 1 0 -n 1 tbs -en tbs 1 tbs -n 2 tbs -en tbs 2 tbs -ema tbs 2 0 tbs tbs 0 -ej tbs 2 1 -eN tbs tbs # for "AM"
                        cout+="{0} {1:.5f} {2:.5f} {3} {4} {5} {6:.5f} {7:.5f} {8:.5f} {9:.5f} {13:.5f} {14:.5f} {15:.5f} {10:.5f} {11:.5f} {12:.5f} {13:.5f} {14:.5f} {15:.5f} {16:.5f}".format(int(nspA[loc])+int(nspB[loc]), float(theta[loc]), float(rho[loc]), int(L[loc]), int(nspA[loc]), int(nspB[loc]), 0, 0, float(n1priorGenomic["values"][loc]), tauN1past, n1pastprior*float(n1priorGenomic["values"][loc]), float(n2priorGenomic["values"][loc]), tauN2past, n2pastprior*float(n2priorGenomic["values"][loc]), float(TsplitGenomic[loc]), float(TsplitGenomic[loc]), float(nApriorGenomic["values"][loc]), TsmallGenomic[loc], float(M1priorGenomic["values"][loc]), float(M2priorGenomic["values"][loc]))
		if(model=="SC"):
			#msnsam tbs 200 -t tbs -r tbs tbs -I 2 tbs tbs 0 -m 1 2 tbs -m 2 1 tbs -n 1 tbs -en tbs 1 tbs -n 2 tbs -en tbs 2 tbs -eM tbs 0 -ej tbs 2 1 -eN tbs tbs # for 'SC'
                        cout+="{0} {1:.5f} {2:.5f} {3} {4} {5} {6:.5f} {7:.5f} {8:.5f} {9:.5f} {13:.5f} {10:.5f} {11:.5f} {12:.5f} {13:.5f} {14:.5f} {15:.5f} {16:.5f}".format(int(nspA[loc])+int(nspB[loc]), float(theta[loc]), float(rho[loc]), int(L[loc]), int(nspA[loc]), int(nspB[loc]), float(M1priorGenomic["values"][loc]), float(M2priorGenomic["values"][loc]), float(n1priorGenomic["values"][loc]), tauN1past, n1pastprior*float(n1priorGenomic["values"][loc]), float(n2priorGenomic["values"][loc]), tauN2past, n2pastprior*float(n2priorGenomic["values"][loc]), float(TsplitGenomic[loc]), float(TsplitGenomic[loc]), float(nApriorGenomic["values"][loc]), float(TsmallGenomic[loc]))
		print(cout)
