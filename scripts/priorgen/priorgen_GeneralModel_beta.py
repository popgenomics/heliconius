...
for i in range(nreps):
	...
	if(Nvariation=="hetero"):
		...
		n1priorGenomic = [ n1prior * nPrior for nPrior in nPriorGenomic["values"] ]
		n2priorGenomic = [ n2prior * nPrior for nPrior in nPriorGenomic["values"] ]
		nApriorGenomic = [ nAprior * nPrior for nPrior in nPriorGenomic["values"] ]
...
#			M2priorGenomic["values"]=M1priorGenomic["values"]
		...
		if(sym=="asym"):
			...
			M2priorGenomic["min"]=M2prior
			M2priorGenomic["max"]=M2prior
